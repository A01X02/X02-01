...
// ════════════════════════════════════════
// 国内模式：使用 CloudBase PG 适配层
// ════════════════════════════════════════
if (IS_DOMESTIC) {
  // CloudBase 适配层在 cloudbase-client.ts 中实现
  // 导出接口签名与下方 Supabase 完全一致，业务代码零改动
  const { domesticClient, domesticAdminClient } = require('./cloudbase-client')
  export const supabase: any = domesticClient
  export const supabaseAdmin: any = domesticAdminClient
} else {
  // ════════════════════════════════════════
  // 海外模式：原生 Supabase（默认）
  // ════════════════════════════════════════
